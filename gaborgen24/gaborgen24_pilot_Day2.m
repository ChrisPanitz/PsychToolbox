function gaborgen24_pilot_Day2(subNo, csPerm, forceSubAndPerm)
...
% US parameters - obsolete but just in case
...
logFilePrefix = 'gaborgen24_pilot_Day2'; % TODO: come up with something more specific
logFilePrefixDay1 = 'gaborgen24_pilot_Day1'; % TODO: come up with something more specific
ratFileFolder = '/home/andreaskeil/Desktop/As_Exps/gaborgen24/ratings/';
ratFilePrefix = 'gaborgen24_pilot_Day2'; % TODO: come up with something more specific
ratAllFileFolder = '/home/andreaskeil/Desktop/As_Exps/gaborgen24/ratings/';
ratAllFilePrefix = 'gaborgen24_pilot_Day2'; % TODO: come up with something more specific
...
welcomeMsg_firstRat = ['Everything has been set up now. To start, please answer' ...
                       'the questions about the pictures you know from yesterday.\n\n' ...
                       'Please continue by pressing any mouse button.'];
welcomeMsg_partStart = ['In the upcoming task you will be presented the flickering' ...
                        'pictures like yesterday. Please pay attention\n' ...
                        'to them. Every now and then you will be asked to\n' ...
                        'answer the questions about how you experience the pictures.\n'...
                        'After each round of questions, you can take a \n' ...
                        'short break before continuing. The whole task will\n' ...
                        'last about 30 minutes today.\n\n\n' ...
...
trialsPerBlockRecall = nrCS*nrTrialsRecall; % how many trials per EXT block across all CS

% initialize (empty) trialMat to store CS type, US [yes/no] & ITI duration
trialMat = NaN(nrBlocksRecall*trialsPerBlockRecall, 3);
...
for bl = 1:nrBlocksRecall
    tempMat = NaN(trialsPerBlockRecall,3);
...
try
    ...
    % brief sound check
%     DrawFormattedText(w, 'This is a quick sound check', 'center', 'center');
%     Screen('Flip', w);
%     WaitSecs(2);
%     Beeper(1000, .02, 1);
%     WaitSecs(2);
    ...
    DrawFormattedText(w, welcomeMsg_firstRat, 'center', 'center');
    Screen('Flip', w);
    waitForClick();
    presFix(w,1);
    ...
    % instruction screen, terminated by participant mouse click
