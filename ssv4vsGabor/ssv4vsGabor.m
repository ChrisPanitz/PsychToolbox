...
%% Header
% for logfiles
logFileFolder = '/home/andreaskeil/Desktop/As_Exps/ssv4vsGabor/logfiles/';
logFilePrefix = 'ssv4vsGabor'; % change for new study

% trial parameters 
trPerPic = 4; % # of picture presentations per pic & condition
breakAftTr = 128; % breaks after how many trials?
minMaxItiSec = [.8 3]; % min & max ITI in sec, taken from exponential distribution

% flicker parameters
% frPerCyc for 120Hz screen: 20 = 6 Hz, 8 = 15 Hz
frPerCyc = [20 8]; % duration of one cycle in frames (for different frequencies)
...
% folder with images
imFolder = '/home/andreaskeil/Desktop/As_Exps/ssv4vsGabor/imageStimuli/'; % path for image files
...
imFileList = {'pic01.jpg', 'pic02.jpg', 'pic03.jpg', 'pic04.jpg', ...
              ...
              'pic21.jpg', 'pic22.jpg', 'pic23.jpg', 'pic24.jpg', ...
              'pic25.jpg', 'pic26.jpg', 'pic27.jpg', 'pic28.jpg', ...
              'pic29.jpg', 'pic30.jpg', 'pic31.jpg', 'pic32.jpg', ...
              'pic33.jpg', 'pic34.jpg', 'pic35.jpg', 'pic36.jpg', ...
              'pic37.jpg', 'pic38.jpg', 'pic39.jpg', 'pic40.jpg'};
...
welcomeMsg_partStart = ['Everything has been set up now. In the upcoming\n' ...
                        ...
                        'will take about 40 to 45 minutes with several\n' ...
...
try
    ...
    end % filling imageMat and textureVec (in loop)
    ...
    for trial = 1 : size(condVec,1)
        ...
        % combCond: 1st digit = first/second set of 10 pics, 2nd = frequency index, 3rd = modulation index 
        combCond = ceil(condVec(trial,3)/10)*100 + condVec(trial,1)*10 + condVec(trial,2);
